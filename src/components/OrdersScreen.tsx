...
const s=StyleSheet.create({
  page:{paddingTop:18,paddingBottom:96},headingRow:{flexDirection:"row",alignItems:"center",justifyContent:"space-between",gap:12},headingRowMobile:{flexDirection:"column",alignItems:"stretch"},headingCopy:{flex:1},title:{fontSize:28,lineHeight:34,fontWeight:"700",color:C.ink,letterSpacing:-.6},subtitle:{marginTop:3,fontSize:15,lineHeight:22,color:C.muted},add:{minHeight:48,paddingHorizontal:16,flexDirection:"row",alignItems:"center",justifyContent:"center",gap:7,borderRadius:12,backgroundColor:C.navy},addMobile:{width:"100%"},addText:{color:C.white,fontSize:14,fontWeight:"700"},
