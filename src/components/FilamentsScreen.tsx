...
const s = StyleSheet.create({
  ...
  spoolNumber: { color: "#111820", fontSize: 20, fontWeight: "700" },
  spoolLabel: {
    color: "#737B82",
    fontSize: 12,
    fontWeight: "700",
  ...
  color: { marginTop: 12, color: "#111820", fontSize: 16, lineHeight: 21, fontWeight: "700" },
  material: { marginTop: 4, color: "#264A3B", fontSize: 14, fontWeight: "700" },
  brand: { marginTop: 4, color: "#626A73", fontSize: 14 },
  note: {
    marginTop: 9,
    flex: 1,
    color: "#626A73",
